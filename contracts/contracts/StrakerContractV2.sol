...
contract StrakerContractV2 {
    ...
    function initialDeposit(uint256 _deposit, IShareToken _sharetoken) public {
    ...
    function createOperator(address _opaddr) public {
        strakertoken.setMaxFlowPermissions(_opaddr);
    }
    ...
    function stake(uint256 _stakingAmount) public {
        ...
        sharetoken.mint(_stakingAmount,msg.sender);
